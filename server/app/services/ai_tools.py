        ...
        "properties": {
            ...
            "settings": {
                ...
                "description": (
                    ...
                    "already has a working Add to Cart button; card_style ('default'|'framed'|'minimal'|'glass'|'elevated') "
                    "only changes how the card looks, never what it does. video_embed: {title (localized), autoplay (bool)}. "
                    ...
                    "'primary'|'accent'|'secondary'|'muted'|'neutral', bento_grid?: boolean}. two_column_layout: {design_variant?: same 5 "
