  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm font-semibold text-gray-700 hover:bg-gray-50"
      >
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-4xl overflow-hidden rounded-xl bg-white shadow-2xl">
            ...
            <div className="grid grid-cols-1 gap-6 p-6 md:grid-cols-3 bg-gray-50 max-h-[70vh] overflow-y-auto">
              {templates.length === 0 ? (
                <div className="col-span-3 py-12 text-center text-gray-500">Loading templates...</div>
              ) : (
